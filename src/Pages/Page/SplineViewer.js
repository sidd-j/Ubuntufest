...
const SplineComponent = () => {
    useEffect(() => {
        ...
        script.onload = () => {
            ...
            // Initialize the viewer after the script is loaded
    ...
    return (
        <div className="spline-container">
            ...
            {/* Spline viewer tag */}
            <spline-viewer className="spline-viewer" url="https://prod.spline.design/1JICLJdcdb0wAH2i/scene.splinecode"></spline-viewer>
